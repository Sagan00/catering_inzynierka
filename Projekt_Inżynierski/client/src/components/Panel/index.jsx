...
const Panel = () => {
    ...
    try {
      if (selectedMeal.id) {
        const response = await axios.put(
          `http://localhost:8080/api/mealsList/${selectedMeal.id}`,
          selectedMeal
        );
        ...
        const response = await axios.post(
          "http://localhost:8080/api/mealsList",
          selectedMeal
        );
        ...
        const updatedMealData = await axios.get(
          "http://localhost:8080/api/mealsList"
        );
  ...
  const handleUserOrderHistory = (userId) => {
    navigate(`/panel/userOrderHistory/${userId}`);
  };
                ...
                <tbody>
                  {mealData.map((meal, index) => (
                    <tr key={index}>
                      ...
                      <td>{meal.name}</td>
                      <td>
                        <button onClick={() => handleModifyClick(meal)}>
                          Modyfikuj
                        </button>
                      </td>
                      <td>
          ...
          <Form>
            ...
            <Form.Group controlId="formCategory">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setSelectedMeal({ ...selectedMeal, category: e.target.value })
                }
              />
            </Form.Group>
            ...
            <Form.Group controlId="formImage">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setSelectedMeal({ ...selectedMeal, image: e.target.value })
                }
              />
            </Form.Group>
            <Form.Group controlId="formProtein">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setSelectedMeal({ ...selectedMeal, protein: e.target.value })
                }
              />
            </Form.Group>
            <Form.Group controlId="formCarbo">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setSelectedMeal({ ...selectedMeal, carbo: e.target.value })
                }
              />
            </Form.Group>
            <Form.Group controlId="formFat">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setSelectedMeal({ ...selectedMeal, fat: e.target.value })
                }
              />
            </Form.Group>
            <Form.Group controlId="formCalories">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setSelectedMeal({ ...selectedMeal, calories: e.target.value })
                }
              />
            </Form.Group>
            <Form.Group controlId="formPortion">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setSelectedMeal({ ...selectedMeal, portion: e.target.value })
                }
              />
            </Form.Group>
          </Form>
